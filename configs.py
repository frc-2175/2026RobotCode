...
driveMotorConfig.closedLoop.feedForward.kV(1 / constants.physicalMaxSpeed) # kV is in volts/(m/s)
...
shooterMotorConfig.encoder.velocityConversionFactor(constants.shooterMotorRatio)
